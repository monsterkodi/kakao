...
class Renderer
{
    ...
    use (n)
    {
        var item, jsFile, kodeFile, m, mod, name, relFile, s, _355_25_, _374_25_, _391_29_
        ...
        if (!_k_.empty(n.items))
        {
            ...
            m = n.toUse[0]
            mod = ((_355_25_=m.text) != null ? _355_25_ : m)
            name = slash.name(mod)
            s += 'import ' + name
            if (mod[0] === '.')
            {
            ...
            for (var _365_21_ = 0; _365_21_ < list.length; _365_21_++)
            {
                item = list[_365_21_]
        ...
        else if (!_k_.empty(n.name))
        {
            ...
            m = n.toUse[0]
            mod = ((_374_25_=m.text) != null ? _374_25_ : m)
            name = slash.name(mod)
            s += 'import ' + n.name
            if (mod[0] === '.')
            {
        ...
        else
        {
            ...
            for (var _386_18_ = 0; _386_18_ < list1.length; _386_18_++)
            {
                ...
                s += 'import ' + name
                mod = ((_391_29_=m.text) != null ? _391_29_ : m)
                if (this.file)
                {
                    if (mod[0] === '.')
                    {
    ...
    class (n)
    {
        var b, bind, bn, con, e, mi, mthds, s, superCall, _486_29_, _492_50_
        ...
        {
            var _481_24_ = this.prepareMethods(mthds); con = _481_24_[0]; bind = _481_24_[1]

            if (bind.length)
            {
                var list = _k_.list(con.keyval.val.func.body.exps)
                for (var _485_22_ = 0; _485_22_ < list.length; _485_22_++)
                {
                    e = list[_485_22_]
                ...
                for (var _490_22_ = 0; _490_22_ < list1.length; _490_22_++)
                {
                    b = list1[_490_22_]
                    bn = b.keyval.val.func.name.text
                    con.keyval.val.func.body.exps = ((_492_50_=con.keyval.val.func.body.exps) != null ? _492_50_ : [])
            ...
            this.indent = '    '
            for (var _501_22_ = mi = 0, _501_26_ = mthds.length; (_501_22_ <= _501_26_ ? mi < mthds.length : mi > mthds.length); (_501_22_ <= _501_26_ ? ++mi : --mi))
            {
                if (mi)
                {
                    s += '\n'
    ...
    function (n)
    {
        var b, bind, bn, callsSuper, con, e, mi, mthds, s, _577_50_, _583_46_
        ...
        if ((mthds != null ? mthds.length : undefined))
        {
            var _572_24_ = this.prepareMethods(mthds); con = _572_24_[0]; bind = _572_24_[1]

            if (bind.length)
            {
                var list1 = _k_.list(bind)
                for (var _575_22_ = 0; _575_22_ < list1.length; _575_22_++)
                {
                    b = list1[_575_22_]
                    bn = b.keyval.val.func.name.text
                    con.keyval.val.func.body.exps = ((_577_50_=con.keyval.val.func.body.exps) != null ? _577_50_ : [])
                    con.keyval.val.func.body.exps.unshift({type:'code',text:`this[\"${bn}\"] = this[\"${bn}\"].bind(this)`})
                }
            }
            if (n.extends)
            {
                con.keyval.val.func.body.exps = ((_583_46_=con.keyval.val.func.body.exps) != null ? _583_46_ : [])
                var list2 = _k_.list(con.keyval.val.func.body.exps)
                for (var _584_22_ = 0; _584_22_ < list2.length; _584_22_++)
                {
                    e = list2[_584_22_]
            ...
            this.indent = '    '
            for (var _594_22_ = mi = 0, _594_26_ = mthds.length; (_594_22_ <= _594_26_ ? mi < mthds.length : mi > mthds.length); (_594_22_ <= _594_26_ ? ++mi : --mi))
            {
    ...
    funcs (n, className)
    {
        var f, member, s, _614_23_, _614_28_, _629_23_, _629_28_, _629_34_

        s = ''
        if (f = ((_614_23_=n.keyval) != null ? (_614_28_=_614_23_.val) != null ? _614_28_.func : undefined : undefined))
        {
        ...
        {
            if (((_629_23_=n.keyval) != null ? (_629_28_=_629_23_.key) != null ? (_629_34_=_629_28_.text) != null ? _629_34_[0] : undefined : undefined : undefined) === '@')
            {
    ...
    {
        var ast, bind, con, m, name, _658_37_

        bind = []
        var list = _k_.list(mthds)
        for (var _643_14_ = 0; _643_14_ < list.length; _643_14_++)
        {
            m = list[_643_14_]
            if (!m.keyval)
            {
    ...
    func (n, name)
    {
        var args, gi, s, str, t, ths, vs, _681_22_, _681_29_, _694_21_, _694_29_, _704_22_, _704_32_
        ...
        gi = this.ind()
        name = (name != null ? name : ((_681_29_=(n.name != null ? n.name.text : undefined)) != null ? _681_29_ : 'function'))
        if (n.arrow.text[0] === '○')
        {
        ...
        s = name
        s += ' ('
        args = ((_694_21_=n.args) != null ? (_694_29_=_694_21_.parens) != null ? _694_29_.exps : undefined : undefined)
        if (args)
        {
            var _696_23_ = this.args(args); str = _696_23_[0]; ths = _696_23_[1]
        ...
        if (((_704_22_=n.body.exps) != null ? _704_22_[0] != null ? (_704_32_=_704_22_[0].call) != null ? _704_32_.callee.text : undefined : undefined : undefined) === 'super')
        {
            s += '\n'
        ...
        if (!_k_.empty(ths))
        {
            ...
            for (var _717_18_ = 0; _717_18_ < list.length; _717_18_++)
            {
                t = list[_717_18_]
                s += this.indent + t + '\n'
            }
    ...
    args (args)
    {
        ...
        for (var _753_14_ = 0; _753_14_ < list.length; _753_14_++)
        {
            a = list[_753_14_]
            if (a.text)
            {
                ...
                if (used[txt])
                {
                    for (i = 1; i <= 100; i++)
                    {
                        if (!used[txt + i])
                        {
                            ...
                            txt += i
                            used[txt] = txt
                            return `${txt}` + (((_768_63_=t.split('=')[1]) != null ? _768_63_ : ''))
                        }
                    }
                }
                else
    ...
    if (n)
    {
        ...
        for (var _893_17_ = 0; _893_17_ < list.length; _893_17_++)
        {
            elif = list[_893_17_]
            s += '\n'
    ...
    ifInline (n, dontClose)
    {
        ...
        {
            s += (function () { var r_924_33_ = []; var list = _k_.list(n.then); for (var _924_33_ = 0; _924_33_ < list.length; _924_33_++)  { e = list[_924_33_];r_924_33_.push(this.atom(e))  } return r_924_33_ }).bind(this)().join(', ')
        }
        if (n.elifs)
        {
            var list1 = _k_.list(n.elifs)
            for (var _927_18_ = 0; _927_18_ < list1.length; _927_18_++)
            {
                e = list1[_927_18_]
                s += ' : '
        ...
        if (n.else)
        {
            ...
            {
                s += '(' + (function () { var r_936_42_ = []; var list2 = _k_.list(n.else); for (var _936_42_ = 0; _936_42_ < list2.length; _936_42_++)  { e = list2[_936_42_];r_936_42_.push(this.atom(e))  } return r_936_42_ }).bind(this)().join(', ') + ')'
            }
        }
        else if (!dontClose)
        {
    ...
    each (n)
    {
        var fnc, i, numArgs, rv, _949_33_, _994_35_
...
${i}})(${this.node(n.lhs)})
    ...
    {
        var e, eb, g2, gi, iterVar, j, list, listVar, nl, postfix, prefix, s, v, _1046_27_, _1068_28_
        ...
        {
            if (((_1046_27_=n.list.array) != null ? _1046_27_.items[0] != null ? _1046_27_.items[0].slice : undefined : undefined) || n.list.slice)
            {
        ...
        else if ((n.vals.array != null ? n.vals.array.items : undefined))
        {
            s += gi + `for (var ${iterVar} = 0; ${iterVar} < ${listVar}.length; ${iterVar}++)` + nl
            s += gi + "{" + nl
            for (var _1071_21_ = j = 0, _1071_25_ = n.vals.array.items.length; (_1071_21_ <= _1071_25_ ? j < n.vals.array.items.length : j > n.vals.array.items.length); (_1071_21_ <= _1071_25_ ? ++j : --j))
            {
        ...
        for (var _1080_14_ = 0; _1080_14_ < list1.length; _1080_14_++)
        {
            e = list1[_1080_14_]
    ...
    {
        var e, eb, end, g2, gi, invCmp, iterCmp, iterDir, iterEnd, iterStart, iterVar, llc, loopCheck, loopStart, loopUpdate, lv, nl, postfix, prefix, rlc, rv, s, slice, start, _1097_28_, _1097_46_, _1107_32_

        slice = ((_1097_46_=((_1097_28_=n.list.array) != null ? _1097_28_.items[0] != null ? _1097_28_.items[0].slice : undefined : undefined)) != null ? _1097_46_ : n.list.slice)
        gi = lineBreak || this.ind()
        nl = lineBreak || '\n'
        eb = lineBreak && ';' || '\n'
        g2 = lineBreak ? '' : this.indent
        iterVar = ((_1107_32_=n.vals.text) != null ? _1107_32_ : n.vals[0].text)
        ...
        for (var _1145_14_ = 0; _1145_14_ < list.length; _1145_14_++)
        {
            e = list[_1145_14_]
            prefix = lastPrefix && e === n.then.slice(-1)[0] ? lastPrefix : ''
            postfix = lastPostfix && e === n.then.slice(-1)[0] ? lastPostfix : ''
    ...
    {
        var e, eb, g2, gi, key, nl, obj, postfix, prefix, s, val, _1167_26_

        gi = lineBreak || this.ind()
        nl = lineBreak || '\n'
        eb = lineBreak && ';' || '\n'
        g2 = lineBreak ? '' : this.indent
        key = ((_1167_26_=n.vals.text) != null ? _1167_26_ : (n.vals[0] != null ? n.vals[0].text : undefined))
        ...
        var list = _k_.list(n.then)
        for (var _1176_14_ = 0; _1176_14_ < list.length; _1176_14_++)
        {
            e = list[_1176_14_]
            prefix = lastPrefix && e === n.then.slice(-1)[0] ? lastPrefix : ''
            postfix = lastPostfix && e === n.then.slice(-1)[0] ? lastPostfix : ''
    ...
    switch (n)
    {
        ...
        if (!_k_.empty(n.else))
        {
            ...
            for (var _1245_18_ = 0; _1245_18_ < list1.length; _1245_18_++)
            {
                e = list1[_1245_18_]
    ...
    when (n)
    {
        ...
        for (var _1264_14_ = 0; _1264_14_ < list.length; _1264_14_++)
        {
            e = list[_1264_14_]
        ...
        var list1 = _k_.list(n.then)
        for (var _1267_14_ = 0; _1267_14_ < list1.length; _1267_14_++)
        {
            e = list1[_1267_14_]
            gi = this.ind()
            s += gi + '    ' + this.node(e) + '\n'
    ...
    operation (op)
    {
        var close, first, i, ind, keyval, lhs, o, open, opmap, prfx, ro, s, sep, v, val, _1375_29_, _1375_40_, _1407_25_, _1407_43_, _1407_54_, _1407_64_, _1431_18_, _1431_29_, _1436_25_, _1480_43_
        ...
        opmap = function (o)
        {
            ...
            return ((_1368_19_=omp[o]) != null ? _1368_19_ : o)
        }
        ...
        if (_k_.in(o,['<','<=','===','!==','>=','>','_k_.eql']))
        {
            ro = opmap(((_1375_29_=op.rhs) != null ? (_1375_40_=_1375_29_.operation) != null ? _1375_40_.operator.text : undefined : undefined))
        ...
        if (o === '=')
        {
            if (op.lhs.object)
            {
                ...
                for (var _1386_31_ = 0; _1386_31_ < list.length; _1386_31_++)
                {
                    keyval = list[_1386_31_]
            ...
            if (op.lhs.array)
            {
                ...
                for (var _1395_28_ = 0; _1395_28_ < list1.length; _1395_28_++)
                {
                    val = list1[_1395_28_]
        ...
        {
            if ((op.rhs != null ? op.rhs.incond : undefined) || _k_.in(((_1407_43_=op.rhs) != null ? (_1407_54_=_1407_43_.operation) != null ? (_1407_64_=_1407_54_.operator) != null ? _1407_64_.text : undefined : undefined : undefined),['=','is']))
            {
                open = '('
                close = ')'
            }
        ...
        else if (((_1431_18_=op.rhs) != null ? (_1431_29_=_1431_18_.operation) != null ? _1431_29_.operator.text : undefined : undefined) === '=')
        {
            open = '('
            close = ')'
        }
    ...
    index (p)
    {
        var addOne, from, ni, slice, u, upper, upto, _1549_32_, _1553_32_, _1555_25_, _1555_54_, _1571_27_
    ...
    slice (p)
    {
        ...
        if ((p.from.type === 'num' && 'num' === (p.upto != null ? p.upto.type : undefined)))
        {
            ...
            if (upto - from <= 10)
            {
                ...
                return '[' + ((function () { var r_1606_30_ = []; for (var _1606_34_ = x = from, _1606_40_ = upto; (_1606_34_ <= _1606_40_ ? x <= upto : x >= upto); (_1606_34_ <= _1606_40_ ? ++x : --x))  { r_1606_30_.push(x)  } return r_1606_30_ }).bind(this)().join(',')) + ']'
            }
            else
            {
                o = p.dots.text === '...' ? '<' : '<='
    ...
    stripol (chunks)
    {
        ...
        for (var _1623_18_ = 0; _1623_18_ < list.length; _1623_18_++)
        {
            chunk = list[_1623_18_]
            t = chunk.text
            switch (chunk.type)
            {
                case 'open':
    ...
    sortVars (vars)
    {
        ...
        vl = (function () { var r_1723_27_ = []; var list = _k_.list(vars); for (var _1723_27_ = 0; _1723_27_ < list.length; _1723_27_++)  { v = list[_1723_27_];r_1723_27_.push(v.text)  } return r_1723_27_ }).bind(this)()
    ...
    freshVar (name, suffix = 0)
    {
        ...
        for (var _1738_17_ = 0; _1738_17_ < list.length; _1738_17_++)
        {
            vars = list[_1738_17_]
            var list1 = _k_.list(vars)
            for (var _1739_18_ = 0; _1739_18_ < list1.length; _1739_18_++)
            {
                v = list1[_1739_18_]
