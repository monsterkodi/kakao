...
var ext, exts, json, jsonFile, keywords, lang, names, noonFile, value, word, words, _25_18_
...
lang = {}
exts = ['txt','log']
for (names in noon.load(noonFile))
{
    keywords = noon.load(noonFile)[names]
