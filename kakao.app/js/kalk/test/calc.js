...
toExport["calc"] = function ()
{
    ...
    {
        dict = {'':{'+':'+','-':'-','¹⧸ₓ':'1/','√':'√('},'log(':{'𝒆ˣ':'log(𝒆^'},'sin(':{'✘':''},'sin':{'✘':''},'√(':{'✘':''},'√':{'✘':''},'NaN':{'✘':'','1':'1','sin':'sin(','¹⧸ₓ':'1/','𝒆ˣ':'𝒆^'},'1/':{'𝒆ˣ':'1/𝒆^'},'1/':{'¹⧸ₓ':'1/1/'},'':{'⌗':'0x'},'16^2':{'⌗':'0x100'},'64^2':{'⌗':'0x1000'},'256^2':{'⌗':'0x10000'},'0xaa+':{'⌗':'0xaa+0x'},'0':{'x':'0x'},'0xf':{'f':'0xff'},'0xf0':{'f':'0xf0f'},'':{'f':'0xf'},'8':{'f':'0x8f'},'2+':{'f':'2+0xf'}}
        for (t in dict)
        {
            keyResult = dict[t]
