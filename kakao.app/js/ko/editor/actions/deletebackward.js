...
export default {
    actions:{menu:'Delete',deleteBackward:{name:'Delete Backward',combo:'backspace'},deleteBackwardWord:{name:'Delete Backward Word',combo:'command+backspace'},deleteBackwardSwallowWhitespace:{name:'Delete Backward Over Whitespace',combo:'alt+backspace'},deleteBackwardIgnoreLineBoundary:{name:'Delete Backward Over Line Boundaries',combo:'command+alt+backspace'}},
