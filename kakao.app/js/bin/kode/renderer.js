...
class Renderer
{
    ...
    use (n)
    {
        ...
        for (var _347_14_ = 0; _347_14_ < list.length; _347_14_++)
        {
            ...
            if (this.file)
            {
                ...
                if (fs.fileExists(kodeFile) || fs.fileExists(jsFile))
                {
    ...
    class (n)
    {
        var b, bind, bn, con, e, mi, mthds, s, superCall, _435_29_, _441_50_
        ...
        {
            var _430_24_ = this.prepareMethods(mthds); con = _430_24_[0]; bind = _430_24_[1]

            if (bind.length)
            {
                var list = _k_.list(con.keyval.val.func.body.exps)
                for (var _434_22_ = 0; _434_22_ < list.length; _434_22_++)
                {
                    e = list[_434_22_]
            ...
            this.indent = '    '
            for (var _450_22_ = mi = 0, _450_26_ = mthds.length; (_450_22_ <= _450_26_ ? mi < mthds.length : mi > mthds.length); (_450_22_ <= _450_26_ ? ++mi : --mi))
            {
                if (mi)
                {
                    s += '\n'
    ...
    function (n)
    {
        var b, bind, bn, callsSuper, con, e, mi, mthds, s, _526_50_, _532_46_
        ...
        if (n.extends)
        {
            ...
            for (var _512_18_ = 0; _512_18_ < list.length; _512_18_++)
            {
                e = list[_512_18_]
        ...
        if ((mthds != null ? mthds.length : undefined))
        {
            var _521_24_ = this.prepareMethods(mthds); con = _521_24_[0]; bind = _521_24_[1]

            if (bind.length)
            {
                var list1 = _k_.list(bind)
                for (var _524_22_ = 0; _524_22_ < list1.length; _524_22_++)
                {
                    b = list1[_524_22_]
                    bn = b.keyval.val.func.name.text
                    con.keyval.val.func.body.exps = ((_526_50_=con.keyval.val.func.body.exps) != null ? _526_50_ : [])
                    con.keyval.val.func.body.exps.unshift({type:'code',text:`this[\"${bn}\"] = this[\"${bn}\"].bind(this)`})
                }
            }
            if (n.extends)
            {
                con.keyval.val.func.body.exps = ((_532_46_=con.keyval.val.func.body.exps) != null ? _532_46_ : [])
                var list2 = _k_.list(con.keyval.val.func.body.exps)
                for (var _533_22_ = 0; _533_22_ < list2.length; _533_22_++)
                {
                    e = list2[_533_22_]
            ...
            this.indent = '    '
            for (var _543_22_ = mi = 0, _543_26_ = mthds.length; (_543_22_ <= _543_26_ ? mi < mthds.length : mi > mthds.length); (_543_22_ <= _543_26_ ? ++mi : --mi))
            {
    ...
    funcs (n, className)
    {
        var f, member, s, _563_23_, _563_28_, _578_23_, _578_28_, _578_34_

        s = ''
        if (f = ((_563_23_=n.keyval) != null ? (_563_28_=_563_23_.val) != null ? _563_28_.func : undefined : undefined))
        {
        ...
        {
            if (((_578_23_=n.keyval) != null ? (_578_28_=_578_23_.key) != null ? (_578_34_=_578_28_.text) != null ? _578_34_[0] : undefined : undefined : undefined) === '@')
            {
    ...
    {
        var ast, bind, con, m, name, _607_37_
    ...
    func (n, name)
    {
        var args, gi, s, str, t, ths, vs, _630_22_, _630_29_, _643_21_, _643_29_, _653_22_, _653_32_
        ...
        gi = this.ind()
        name = (name != null ? name : ((_630_29_=(n.name != null ? n.name.text : undefined)) != null ? _630_29_ : 'function'))
        if (n.arrow.text[0] === '○')
        {
        ...
        s = name
        s += ' ('
        args = ((_643_21_=n.args) != null ? (_643_29_=_643_21_.parens) != null ? _643_29_.exps : undefined : undefined)
        if (args)
        {
            var _645_23_ = this.args(args); str = _645_23_[0]; ths = _645_23_[1]
        ...
        if (((_653_22_=n.body.exps) != null ? _653_22_[0] != null ? (_653_32_=_653_22_[0].call) != null ? _653_32_.callee.text : undefined : undefined : undefined) === 'super')
        {
            s += '\n'
        ...
        if (!_k_.empty(ths))
        {
            ...
            for (var _666_18_ = 0; _666_18_ < list.length; _666_18_++)
            {
                t = list[_666_18_]
                s += this.indent + t + '\n'
            }
    ...
    args (args)
    {
        ...
        for (var _702_14_ = 0; _702_14_ < list.length; _702_14_++)
        {
            a = list[_702_14_]
            if (a.text)
            {
                ...
                if (used[txt])
                {
                    for (i = 1; i <= 100; i++)
                    {
                        if (!used[txt + i])
                        {
                            ...
                            txt += i
                            used[txt] = txt
                            return `${txt}` + (((_717_63_=t.split('=')[1]) != null ? _717_63_ : ''))
                        }
                    }
                }
                else
    ...
    if (n)
    {
        ...
        for (var _842_17_ = 0; _842_17_ < list.length; _842_17_++)
        {
            elif = list[_842_17_]
            s += '\n'
    ...
    ifInline (n, dontClose)
    {
        ...
        {
            s += (function () { var r_873_33_ = []; var list = _k_.list(n.then); for (var _873_33_ = 0; _873_33_ < list.length; _873_33_++)  { e = list[_873_33_];r_873_33_.push(this.atom(e))  } return r_873_33_ }).bind(this)().join(', ')
        }
        if (n.elifs)
        {
            var list1 = _k_.list(n.elifs)
            for (var _876_18_ = 0; _876_18_ < list1.length; _876_18_++)
            {
                e = list1[_876_18_]
                s += ' : '
        ...
        if (n.else)
        {
            ...
            {
                s += '(' + (function () { var r_885_42_ = []; var list2 = _k_.list(n.else); for (var _885_42_ = 0; _885_42_ < list2.length; _885_42_++)  { e = list2[_885_42_];r_885_42_.push(this.atom(e))  } return r_885_42_ }).bind(this)().join(', ') + ')'
            }
        }
        else if (!dontClose)
        {
    ...
    each (n)
    {
        var fnc, i, numArgs, rv, _898_33_, _943_35_
...
${i}})(${this.node(n.lhs)})
    ...
    {
        var e, eb, g2, gi, iterVar, j, list, listVar, nl, postfix, prefix, s, v, _1017_28_, _995_27_
        ...
        {
            if (((_995_27_=n.list.array) != null ? _995_27_.items[0] != null ? _995_27_.items[0].slice : undefined : undefined) || n.list.slice)
            {
        ...
        else if ((n.vals.array != null ? n.vals.array.items : undefined))
        {
            s += gi + `for (var ${iterVar} = 0; ${iterVar} < ${listVar}.length; ${iterVar}++)` + nl
            s += gi + "{" + nl
            for (var _1020_21_ = j = 0, _1020_25_ = n.vals.array.items.length; (_1020_21_ <= _1020_25_ ? j < n.vals.array.items.length : j > n.vals.array.items.length); (_1020_21_ <= _1020_25_ ? ++j : --j))
            {
    ...
    {
        var e, eb, end, g2, gi, invCmp, iterCmp, iterDir, iterEnd, iterStart, iterVar, llc, loopCheck, loopStart, loopUpdate, lv, nl, postfix, prefix, rlc, rv, s, slice, start, _1046_28_, _1046_46_, _1056_32_

        slice = ((_1046_46_=((_1046_28_=n.list.array) != null ? _1046_28_.items[0] != null ? _1046_28_.items[0].slice : undefined : undefined)) != null ? _1046_46_ : n.list.slice)
        gi = lineBreak || this.ind()
        nl = lineBreak || '\n'
        eb = lineBreak && ';' || '\n'
        g2 = lineBreak ? '' : this.indent
        iterVar = ((_1056_32_=n.vals.text) != null ? _1056_32_ : n.vals[0].text)
    ...
    {
        var e, eb, g2, gi, key, nl, obj, postfix, prefix, s, val, _1116_26_

        gi = lineBreak || this.ind()
        nl = lineBreak || '\n'
        eb = lineBreak && ';' || '\n'
        g2 = lineBreak ? '' : this.indent
        key = ((_1116_26_=n.vals.text) != null ? _1116_26_ : (n.vals[0] != null ? n.vals[0].text : undefined))
        ...
        var list = _k_.list(n.then)
        for (var _1125_14_ = 0; _1125_14_ < list.length; _1125_14_++)
        {
            e = list[_1125_14_]
            prefix = lastPrefix && e === n.then.slice(-1)[0] ? lastPrefix : ''
            postfix = lastPostfix && e === n.then.slice(-1)[0] ? lastPostfix : ''
    ...
    switch (n)
    {
        ...
        for (var _1189_14_ = 0; _1189_14_ < list.length; _1189_14_++)
        {
            e = list[_1189_14_]
            s += gi + this.node(e) + '\n'
        }
        if (!_k_.empty(n.else))
        {
            ...
            for (var _1194_18_ = 0; _1194_18_ < list1.length; _1194_18_++)
            {
                e = list1[_1194_18_]
    ...
    when (n)
    {
        ...
        var list1 = _k_.list(n.then)
        for (var _1216_14_ = 0; _1216_14_ < list1.length; _1216_14_++)
        {
            e = list1[_1216_14_]
            gi = this.ind()
            s += gi + '    ' + this.node(e) + '\n'
    ...
    operation (op)
    {
        var close, first, i, ind, keyval, lhs, o, open, opmap, prfx, ro, s, sep, v, val, _1324_29_, _1324_40_, _1356_25_, _1356_43_, _1356_54_, _1356_64_, _1380_18_, _1380_29_, _1385_25_, _1429_43_
        ...
        opmap = function (o)
        {
            ...
            return ((_1317_19_=omp[o]) != null ? _1317_19_ : o)
        }
        ...
        if (_k_.in(o,['<','<=','===','!==','>=','>','_k_.eql']))
        {
            ro = opmap(((_1324_29_=op.rhs) != null ? (_1324_40_=_1324_29_.operation) != null ? _1324_40_.operator.text : undefined : undefined))
        ...
        if (o === '=')
        {
            if (op.lhs.object)
            {
                ...
                for (var _1335_31_ = 0; _1335_31_ < list.length; _1335_31_++)
                {
                    keyval = list[_1335_31_]
            ...
            if (op.lhs.array)
            {
                ...
                for (var _1344_28_ = 0; _1344_28_ < list1.length; _1344_28_++)
                {
                    val = list1[_1344_28_]
        ...
        {
            if ((op.rhs != null ? op.rhs.incond : undefined) || _k_.in(((_1356_43_=op.rhs) != null ? (_1356_54_=_1356_43_.operation) != null ? (_1356_64_=_1356_54_.operator) != null ? _1356_64_.text : undefined : undefined : undefined),['=','is']))
            {
                open = '('
                close = ')'
            }
        ...
        else if (((_1380_18_=op.rhs) != null ? (_1380_29_=_1380_18_.operation) != null ? _1380_29_.operator.text : undefined : undefined) === '=')
        {
            open = '('
            close = ')'
        }
    ...
    index (p)
    {
        var addOne, from, ni, slice, u, upper, upto, _1498_32_, _1502_32_, _1504_25_, _1504_54_, _1520_27_
    ...
    slice (p)
    {
        ...
        if ((p.from.type === 'num' && 'num' === (p.upto != null ? p.upto.type : undefined)))
        {
            ...
            if (upto - from <= 10)
            {
                ...
                return '[' + ((function () { var r_1555_30_ = []; for (var _1555_34_ = x = from, _1555_40_ = upto; (_1555_34_ <= _1555_40_ ? x <= upto : x >= upto); (_1555_34_ <= _1555_40_ ? ++x : --x))  { r_1555_30_.push(x)  } return r_1555_30_ }).bind(this)().join(',')) + ']'
            }
            else
            {
                o = p.dots.text === '...' ? '<' : '<='
    ...
    stripol (chunks)
    {
        ...
        for (var _1572_18_ = 0; _1572_18_ < list.length; _1572_18_++)
        {
            chunk = list[_1572_18_]
            t = chunk.text
            switch (chunk.type)
            {
                case 'open':
    ...
    sortVars (vars)
    {
        ...
        vl = (function () { var r_1672_27_ = []; var list = _k_.list(vars); for (var _1672_27_ = 0; _1672_27_ < list.length; _1672_27_++)  { v = list[_1672_27_];r_1672_27_.push(v.text)  } return r_1672_27_ }).bind(this)()
    ...
    freshVar (name, suffix = 0)
    {
        ...
        for (var _1687_17_ = 0; _1687_17_ < list.length; _1687_17_++)
        {
            vars = list[_1687_17_]
            var list1 = _k_.list(vars)
            for (var _1688_18_ = 0; _1688_18_ < list1.length; _1688_18_++)
            {
                v = list1[_1688_18_]
