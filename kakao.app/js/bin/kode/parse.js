...
var firstLineCol, lastLineCol, Parse
...
Parse = (function ()
{
    ...
    {
        var block, e, numTokens, tok, _277_34_, _339_33_
        ...
        this.sheapPush('exp',((_277_34_=tok.text) != null ? _277_34_ : tok.type))
        e = tok
        while (tokens.length)
        {
            numTokens = tokens.length
        ...
        this.sheapPop('exp',((_339_33_=tok.text) != null ? _339_33_ : tok.type))
        return e
    }

    Parse.prototype["rhs"] = function (e, tokens)
    {
        var llc, numTokens, nxt, spaced, unspaced, _400_22_
