...
template t(f:(proc (s:string) : string), a:string, b:string) = testCmp(a, f(a), b, instantiationInfo())
suite "slash": 
    ...
    test "parse": 
        check slash.parse("/a/b/c.txt") == (path: "/a/b/c.txt", dir: "/a/b", file: "c.txt", name: "c", ext: "txt")
        check slash.parse("/a/b/c") == (path: "/a/b/c", dir: "/a/b", file: "c", name: "c", ext: "")
        check slash.parse("/a/b/c/") == (path: "/a/b/c", dir: "/a/b", file: "c", name: "c", ext: "")
        check slash.parse("/a") == (path: "/a", dir: "/", file: "a", name: "a", ext: "")
    #     # user = slash.user()
