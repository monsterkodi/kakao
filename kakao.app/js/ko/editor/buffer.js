...
Buffer = (function ()
{
    ...
    Buffer.prototype["selectedLineIndices"] = function ()
    {
        ...
        return uniq((function () { var r_186_45_ = []; var list = _k_.list(this.selections()); for (var _186_45_ = 0; _186_45_ < list.length; _186_45_++)  { s = list[_186_45_];r_186_45_.push(s[0])  } return r_186_45_ }).bind(this)())
    }
    ...
    Buffer.prototype["cursorLineIndices"] = function ()
    {
        ...
        return uniq((function () { var r_187_45_ = []; var list = _k_.list(this.cursors()); for (var _187_45_ = 0; _187_45_ < list.length; _187_45_++)  { c = list[_187_45_];r_187_45_.push(c[1])  } return r_187_45_ }).bind(this)())
    }
    ...
    Buffer.prototype["rangesOfStringsInLineAtIndex"] = function (li)
    {
        ...
        ss = -1
        cc = null
        for (var _373_18_ = i = 0, _373_22_ = t.length; (_373_18_ <= _373_22_ ? i < t.length : i > t.length); (_373_18_ <= _373_22_ ? ++i : --i))
        {
            c = t[i]
            if (!cc && _k_.in(c,"'\""))
            {
