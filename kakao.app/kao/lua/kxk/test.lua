...
function test.static.cmp(a, b) 
        ...
        function cmpTable(a, b) 
            ...
            if ((#a == 0) and (dict.size(a) ~= dict.size(b))) then 
                return fail("\x1b[0m\x1b[90m\x1b[2m", "dict size mismatch ", "\x1b[0m\x1b[34m", dict.size(a), "\x1b[0m\x1b[31m", " != ", "\x1b[0m\x1b[32m", dict.size(b), "\x1b[0m\x1b[90m", " (", dict.str(a), " != ", dict.str(b), ")")
            end
