...
◆4]], "\n"), array("◆1", "◆2", "◆3", "◆4"))
    ...
    test("find", function()
        test.cmp(kstr.find(nil, ""), -1)
        test.cmp(kstr.find(nil, nil), -1)
        test.cmp(kstr.find("", ""), -1)
        test.cmp(kstr.find("abc", ""), -1)
        test.cmp(kstr.find("123.56", nil), -1)
        test.cmp(kstr.find("123.56", "."), 4)
        test.cmp(kstr.find(".23.56", "."), 1)
        test.cmp(kstr.find("some.ext", "e"), 4)
        test.cmp(kstr.find("abc", "d"), -1)
        test.cmp(kstr.find("abc", "bc"), 2)
    end)
    ...
    test("has", function()
        test.cmp(kstr.has("abc", "a"), true)
        test.cmp(kstr.has("abc", "b"), true)
        test.cmp(kstr.has("abc", "c"), true)
        test.cmp(kstr.has("abc", "d"), false)
        test.cmp(kstr.has("abc", "bc"), true)
    end)
