...
var file, files, hdr, m, mods, test, tests
...
if (tests.kxk)
{
    ...
    var list3 = _k_.list(files)
    for (var _60_13_ = 0; _60_13_ < list3.length; _60_13_++)
    {
        file = list3[_60_13_]
...
if (tests.kode)
{
    ...
    for (var _68_13_ = 0; _68_13_ < list4.length; _68_13_++)
    {
        file = list4[_68_13_]
        test = await import(file.path)
        tester.test(test.default)
...
if (tests.ko)
{
    ...
    var list5 = _k_.list(files)
    for (var _81_13_ = 0; _81_13_ < list5.length; _81_13_++)
    {
        file = list5[_81_13_]
        test = await import(file.path)
        tester.test(test.default)
