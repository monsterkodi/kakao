...
var list = _k_.list("dom elem post drag slash stash store prefs matchr immutable linediff karg krzl plot pretty profile keyinfo tooltip events popup scheme kstr kseg kermit scooter pepe clippo kpos util sds fps win os ffs walkdir noon".split(' '))
