...
mapscr = (function ()
{
    ...
    mapscr.prototype["onLinesChanged"] = function (diff)
    {
        ...
        else
        {
            ...
            {
                console.log(`mapscr.onLinesChanged chg ${diff.chg.length} ins ${diff.ins.length} del ${diff.del.length} imgs`)
            }
        }
    }
