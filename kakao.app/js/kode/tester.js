...
var allfails, allsuccs, comps, fail, fails, file, files, stack, succs, test, tester, _211_21_, _211_27_
...
{
    files = await fs.list(slash.path(import.meta.dirname,'test'))
    fail = false
    var list = _k_.list(files)
    for (var _215_13_ = 0; _215_13_ < list.length; _215_13_++)
    {
        file = list[_215_13_]
