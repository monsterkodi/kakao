...
var ext, extlang, extlangFile, exts, json, keywords, lang, langNoon, names, noonFile, value, word, words, __dirname, _34_18_
...
for (names in langNoon)
{
    ...
    for (var _32_12_ = 0; _32_12_ < list.length; _32_12_++)
    {
        ext = list[_32_12_]
        if (!(_k_.in(ext,exts)))
        {
        ...
        lang[ext] = ((_34_18_=lang[ext]) != null ? _34_18_ : {})
        for (value in keywords)
        {
            words = keywords[value]
            var list1 = _k_.list(words)
            for (var _36_21_ = 0; _36_21_ < list1.length; _36_21_++)
            {
                word = list1[_36_21_]
                lang[ext][word] = value
            }
