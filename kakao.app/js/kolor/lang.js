...
var ext, extlang, extlangFile, exts, json, keywords, lang, langNoon, names, noonFile, value, word, words, __dirname, _35_18_
...
for (names in langNoon)
{
    ...
    for (var _33_12_ = 0; _33_12_ < list.length; _33_12_++)
    {
        ext = list[_33_12_]
        if (!(_k_.in(ext,exts)))
        {
        ...
        lang[ext] = ((_35_18_=lang[ext]) != null ? _35_18_ : {})
