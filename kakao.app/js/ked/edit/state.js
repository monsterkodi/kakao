...
state = (function ()
{
    ...
    state.prototype["adjustViewForMainCursor"] = function (opt)
    {
        ...
        {
            topBotDelta = _k_.min(6,parseInt(this.cells.rows / 4))
        }
        else
        {
            topBotDelta = 0
