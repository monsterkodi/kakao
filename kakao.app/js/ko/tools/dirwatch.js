...
Watch = (function ()
{
    ...
    function Watch (path, opt)
    {
        ...
        this.last = {}
        ffs.dirExists(this.dir).then((function (stat)
        {
            if (stat)
            {
    ...
    Watch["watch"] = function (path, opt)
    {
        if (opt.cb)
        {
            return ffs.isDir(path).then(function (stat)
            {
                if (stat)
                {
        ...
        {
            if (ffs.isDir(path).then(function (stat)
                {
                    if (stat)
                    {
    ...
    Watch.prototype["watchDir"] = async function ()
    {
        ...
        console.log('Watch.watchDir',this.dir)
        if (!this.dir)
        {
            return
        }
