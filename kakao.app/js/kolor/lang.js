...
var ext, extlang, extlangFile, exts, json, jsonFile, keywords, lang, langNoon, names, noonFile, value, word, words, __dirname, _36_18_
...
noonFile = slash.path(__dirname,'..','..','kode','kolor','lang.noon')
...
for (names in langNoon)
{
    ...
    for (var _34_12_ = 0; _34_12_ < list.length; _34_12_++)
    {
        ext = list[_34_12_]
        if (!(_k_.in(ext,exts)))
        {
        ...
        lang[ext] = ((_36_18_=lang[ext]) != null ? _36_18_ : {})
