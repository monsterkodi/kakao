...
escape = function ()
{
    var _786_46_, _787_26_, _791_61_, _794_61_
...
mdPunct = function ()
{
    var type, _1033_73_, _1058_21_, _1083_21_
...
shPunct = function ()
{
    var _1215_42_, _1215_64_, _1218_102_, _1218_41_, _1218_82_, _1224_102_, _1224_41_, _1224_82_
...
getValue = function (d)
{
    var _1286_27_, _1286_34_

    return ((_1286_34_=(getChunk(d) != null ? getChunk(d).clss : undefined)) != null ? _1286_34_ : '')
}

getmatch = function (d)
{
    var _1287_27_, _1287_35_

    return ((_1287_35_=(getChunk(d) != null ? getChunk(d).match : undefined)) != null ? _1287_35_ : '')
}
...
{
    var advance, beforeIndex, hnd, mightBeHeader, mtch, turdChunk, _1442_40_, _1457_61_
                ...
                if (!notCode)
                {
                    if (mtch = (swtch[line.ext] != null ? swtch[line.ext][chunk.match] : undefined))
                    {
                        if (mtch.turd)
                        {
                            ...
                            if (mtch.turd === (((_1457_61_=(turdChunk != null ? turdChunk.turd : undefined)) != null ? _1457_61_ : (turdChunk != null ? turdChunk.match : undefined))))
                            {
                                pushExt(mtch)
                            }
                        }
...
syntax = function (arg)
{
    var clines, index, lines, rngs, text, _1534_19_

    arg = (arg != null ? arg : {})
    text = arg.text
    ext = ((_1534_19_=arg.ext) != null ? _1534_19_ : 'coffee')
