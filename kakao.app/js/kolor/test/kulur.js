...
toExport["kulur"] = function ()
{
    ...
    section("noon", function ()
    {
        ...
        compare(inc(rgs,4,'file'),'file_kode')
        compare(inc(rgs,8,'.'),'file_punct_kode')
        compare(inc(rgs,9,'kode'),'file_ext_kode')
        ...
        compare(inc(rgs,5,'some'),'text dir')
        compare(inc(rgs,9,'\\'),'punct dir')
        compare(inc(rgs,19,'.'),'file_punct_txt')
        ...
        compare(inc(rgs,5,'999'),'number hex')
        rgs = ranges("c   #abc")
        compare(inc(rgs,4,"#"),'punct')
        compare(inc(rgs,5,'abc'),'number hex')
        rgs = ranges("c   #abcdef")
        compare(inc(rgs,4,"#"),'punct')
        compare(inc(rgs,5,'abcdef'),'number hex')
    ...
    section("numbers", function ()
    {
        ...
        compare(inc(rgs,1,'f00'),'number hex')
        lang('kode')
        rgs = ranges("#f00")
        compare(inc(rgs,0,"#"),'punct comment')
        compare(inc(rgs,1,'f00'),'comment')
        rgs = ranges("'#f00'")
        compare(inc(rgs,1,"#"),'string single')
        compare(inc(rgs,2,'f00'),'string single')
        rgs = ranges("'#808'")
        compare(inc(rgs,1,"#"),'string single')
        compare(inc(rgs,2,'808'),'string single')
    })
  ...
  "key": [
    ...
    section("styl", function ()
    {
        ...
        compare(inc(rgs,13,'('),'punct minor')
        compare(inc(rgs,14,'"'),'punct string double')
        compare(inc(rgs,15,'.'),'string double')
        compare(inc(rgs,25,'.'),'string double')
        compare(inc(rgs,26,'woff'),'string double')
        compare(inc(rgs,30,'"'),'punct string double')
    })
    ...
    section("log", function ()
    {
        ...
        compare(inc(rgs,0,'file'),'file_coffee')
        compare(inc(rgs,4,'.'),'file_punct_coffee')
        compare(inc(rgs,5,'coffee'),'file_ext_coffee')
        rgs = ranges("/some/path")
