...
var b, compare, dissect, dss, ext, i, inc, klor, Kode, kolor, lang, parse, ranges, rgs, section, t, Tester

Kode = require('../komp/kode').default
Tester = require('../komp/tester').default
klor = require('./klor').default
...
inc = function (rgs, start, match)
{
    ...
    for (var _18_35_ = 0; _18_35_ < list.length; _18_35_++)
    {
        r = list[_18_35_]
...
module.exports["ranges"] = function ()
{
    ...
    section("strings", function ()
    {
        ...
        for (var _277_14_ = 0; _277_14_ < list1.length; _277_14_++)
        {
            i = list1[_277_14_]
