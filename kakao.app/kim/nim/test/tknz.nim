...
suite "tknz":
    ...
    test "strings":
        ...
        check tokenize("\"\"") == @[
            Token(str:"\"",     tok:◆string_start,  line:0, col:0),
            Token(str:"\"",     tok:◆string_end,    line:0, col:1),
            ]

        check tokenize("(\"\")") == @[
            Token(str:"(",      tok:◆paren_open,    line:0, col:0),
            Token(str:"\"",     tok:◆string_start,  line:0, col:1),
            Token(str:"\"",     tok:◆string_end,    line:0, col:2),
            Token(str:")",      tok:◆paren_close,   line:0, col:3),
            ]
        ...
        check tokenize("""rndr("")""") == @[
            Token(str:"rndr",   tok:◆name,          line:0, col:0),
            Token(str:"(",      tok:◆paren_open,    line:0, col:4),
            Token(str:"\"",     tok:◆string_start,  line:0, col:5),
            Token(str:"\"",     tok:◆string_end,    line:0, col:6),
            Token(str:")",      tok:◆paren_close,   line:0, col:7),
            ]

        check tokenize("\"\"\"triple\"\"\"") == @[
            Token(str:"\"\"\"", tok:◆string_start,  line:0, col:0),
            Token(str:"triple", tok:◆string,        line:0, col:3),
            Token(str:"\"\"\"", tok:◆string_end,    line:0, col:9),
            ]
            
        check tokenize("\"\"\"\n\n\"\"\"") == @[
            Token(str:"\"\"\"", tok:◆string_start,  line:0, col:0),
            Token(str:"\n\n",   tok:◆string,        line:0, col:3),
            Token(str:"\"\"\"", tok:◆string_end,    line:2, col:0),
            ]
            
        check tokenize("s = \"\"\"\nl1 #{1}\nl2 #{2}\"\"\"") == @[
            Token(str:"s",      tok:◆name,          line:0, col:0),
            Token(str:"=",      tok:◆assign,        line:0, col:2),
            Token(str:"\"\"\"", tok:◆string_start,  line:0, col:4),
            Token(str:"\nl1 ",  tok:◆string,        line:0, col:7),
            Token(str:"#{",     tok:◆stripol_start, line:1, col:3),
            Token(str:"1",      tok:◆number,        line:1, col:5),
            Token(str:"}",      tok:◆stripol_end,   line:1, col:6),
            Token(str:"\nl2 ",  tok:◆string,        line:1, col:7),
            Token(str:"#{",     tok:◆stripol_start, line:2, col:3),
            Token(str:"2",      tok:◆number,        line:2, col:5),
            Token(str:"}",      tok:◆stripol_end,   line:2, col:6),
            Token(str:"\"\"\"", tok:◆string_end,    line:2, col:7),
            ]
    ...
    test "stripol":
        ...
        check tokenize("\"\"\"#{a}\"\"\"") == @[
            Token(str:"\"\"\"", tok:◆string_start,  line:0, col:0),
            Token(str:"#{",     tok:◆stripol_start, line:0, col:3),
            Token(str:"a",      tok:◆name,          line:0, col:5),
            Token(str:"}",      tok:◆stripol_end,   line:0, col:6),
            Token(str:"\"\"\"", tok:◆string_end,    line:0, col:7),
            ]

        check tokenize("\"head #{a}\"") == @[
            Token(str:"\"",     tok:◆string_start,  line:0, col:0),
            Token(str:"head ",  tok:◆string,        line:0, col:1),
            Token(str:"#{",     tok:◆stripol_start, line:0, col:6),
            Token(str:"a",      tok:◆name,          line:0, col:8),
            Token(str:"}",      tok:◆stripol_end,   line:0, col:9),
            Token(str:"\"",     tok:◆string_end,    line:0, col:10),
            ]
        ...
        check tokenize("s = \"num #{1+2} end\"") == @[
            Token(str:"s",      tok:◆name,          line:0, col:0),
            Token(str:"=",      tok:◆assign,        line:0, col:2),
            Token(str:"\"",     tok:◆string_start,  line:0, col:4),
            Token(str:"num ",   tok:◆string,        line:0, col:5),
            Token(str:"#{",     tok:◆stripol_start, line:0, col:9),
            Token(str:"1",      tok:◆number,        line:0, col:11),
            Token(str:"+",      tok:◆plus,          line:0, col:12),
            Token(str:"2",      tok:◆number,        line:0, col:13),
            Token(str:"}",      tok:◆stripol_end,   line:0, col:14),
            Token(str:" end",   tok:◆string,        line:0, col:15),
            Token(str:"\"",     tok:◆string_end,    line:0, col:19),
            ]
        ...
        check tokenize("s = \"\"\"num #{1+2} end\"\"\"") == @[
            ...
            Token(str:"=",       tok:◆assign,        line:0, col:2),
            Token(str:"\"\"\"",  tok:◆string_start,  line:0, col:4),
            Token(str:"num ",    tok:◆string,        line:0, col:7),
            Token(str:"#{",      tok:◆stripol_start, line:0, col:11),
            Token(str:"1",       tok:◆number,        line:0, col:13),
            Token(str:"+",       tok:◆plus,          line:0, col:14),
            Token(str:"2",       tok:◆number,        line:0, col:15),
            Token(str:"}",       tok:◆stripol_end,   line:0, col:16),
            Token(str:" end",    tok:◆string,        line:0, col:17),
            Token(str:"\"\"\"",  tok:◆string_end,    line:0, col:21),
            ]
...
""") == @[
    ...
    test "use":
        ...
        check tokenize("use std ▪ unittest") == @[ 
            Token(str:"use",      tok:◆use,             line:0, col:0), 
            Token(str:"std",      tok:◆name,            line:0, col:4), 
            Token(str:"▪",        tok:◆name,            line:0, col:8), 
            Token(str:"unittest", tok:◆name,            line:0, col:10)
            ]
        
        check tokenize("use ../rndr") == @[ 
            Token(str:"use",      tok:◆use,             line:0, col:0), 
            Token(str:"..",       tok:◆doubledot,       line:0, col:4),
