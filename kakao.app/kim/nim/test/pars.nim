...
suite "pars":
    ...
    test "func":
        ...
        t "◇string s=\"✔\" ◇int j=1+2 ->"           , "▪[(◆[(◇type(string) ◆name (= ◆string)), (◇type(int) ◆name (= (◆number + ◆number)))] ->)]"
        t "◇string s=\"✔\" ◇int j=1+2 ➜string ->"   , "▪[(◆[(◇type(string) ◆name (= ◆string)), (◇type(int) ◆name (= (◆number + ◆number)))] ➜ type(string) ->)]"
