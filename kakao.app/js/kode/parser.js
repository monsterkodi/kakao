var _k_ = {extend: function (c,p) {for (var k in p) { if (Object.prototype.hasOwnProperty(p, k)) c[k] = p[k] } function ctor() { this.constructor = c; } ctor.prototype = p.prototype; c.prototype = new ctor(); c.__super__ = p.prototype; return c;}, empty: function (l) {return l==='' || l===null || l===undefined || l!==l || typeof(l) === 'object' && Object.keys(l).length === 0}, in: function (a,l) {return (typeof l === 'string' && typeof a === 'string' && a.length ? '' : []).indexOf.call(l,a) >= 0}, noon: function (obj) { 
...
Parser = (function ()
{
    ...
    Parser.prototype["return"] = function (tok, tokens)
    {
        ...
        if ((tokens[0] != null ? tokens[0].type : undefined) !== 'nl')
        {
            ...
            {
                this.onError('unreachable code after return statement?',{tok:tok,tokens:tokens})
            }
    ...
    Parser.prototype["call"] = function (tok, tokens, qmrk)
    {
        ...
        if (open && !close)
        {
            this.onError("explicit call is missing closing bracket )",{tok:tok,tokens:tokens})
        }
        this.pop('call')
        if (!_k_.empty(args))
        {
    ...
    Parser.prototype["keyval"] = function (key, tokens)
    {
        ...
        {
            this.onError(`keyval is missing type or prop in:\n${_k_.noon(key)}`,{tokens:tokens})
        }
