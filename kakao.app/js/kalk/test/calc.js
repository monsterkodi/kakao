...
toExport["calc"] = function ()
{
    ...
    {
        list = [[['1','(1+2)','5.5',symbol.phi],[symbol.deg2rad]],[['1','(1+2)','5.5',symbol.phi],[symbol.rad2deg]],[['1','(1+2)','5.5',symbol.phi],[symbol.pow]],[['','8°','1','(1+2)','5.5','9/10+12',symbol.phi],[symbol.sqrt,symbol.oneoverx,symbol.exp]],[['4-','5+','6/','7*','8^','sin('],[symbol.sqrt,symbol.oneoverx,symbol.exp]],[['1','(1+2)','5.5','9/10+12','8/','5*',symbol.phi],['+','-']],[['','0.','1','5.5','9/10+12','8/','5*'],['1','2','9','0']],[['1+2','9/10+12','8/5'],[symbol.close]],[['','-','+','1*','2/','3^','4-','5+'],[symbol.open]]]
        var list4 = _k_.list(list)
        for (var _56_14_ = 0; _56_14_ < list4.length; _56_14_++)
        {
            l = list4[_56_14_]
            var list5 = _k_.list(l[0])
            for (var _57_18_ = 0; _57_18_ < list5.length; _57_18_++)
            {
                t = list5[_57_18_]
                var list6 = _k_.list(l[1])
                for (var _58_22_ = 0; _58_22_ < list6.length; _58_22_++)
                {
                    k = list6[_58_22_]
    ...
    section("calc", function ()
    {
        ...
        for (var _80_14_ = 0; _80_14_ < list7.length; _80_14_++)
        {
            l = list7[_80_14_]
    ...
    section("equals", function ()
    {
        ...
        for (var _90_14_ = 0; _90_14_ < list8.length; _90_14_++)
        {
            l = list8[_90_14_]
    ...
    section("replace", function ()
    {
        ...
        for (var _100_14_ = 0; _100_14_ < list9.length; _100_14_++)
        {
            l = list9[_100_14_]
    ...
    section("block", function ()
    {
        ...
        for (var _124_14_ = 0; _124_14_ < list10.length; _124_14_++)
        {
            l = list10[_124_14_]
            var list11 = _k_.list(l[0])
            for (var _125_18_ = 0; _125_18_ < list11.length; _125_18_++)
            {
                t = list11[_125_18_]
    ...
    {
        dict = {'':{'+':'+','-':'-','√':'√(','¹⧸ₓ':'1/'},'log(':{'𝒆ˣ':'log(𝒆^'},'sin(':{'✘':''},'sin':{'✘':''},'√(':{'✘':''},'√':{'✘':''},'1/':{'𝒆ˣ':'1/𝒆^'},'1/':{'¹⧸ₓ':'1/1/'}}
        for (t in dict)
        {
            keyResult = dict[t]
