...
XYZ`)
    ...
    {
        segls = kseg.segls('\n1.4   x:z')
        compare(util.chunkBeforePos(segls,[0,0]),'')
        compare(util.chunkBeforePos(segls,[1,0]),'')
        compare(util.chunkBeforePos(segls,[0,1]),'')
        compare(util.chunkBeforePos(segls,[1,1]),'1')
        compare(util.chunkBeforePos(segls,[3,1]),'1.4')
        compare(util.chunkBeforePos(segls,[5,1]),'')
        compare(util.chunkBeforePos(segls,[9,1]),'x:z')
    })
    section("chunkAfterPos", function ()
    {
        segls = kseg.segls('\n1.4   x:z')
        compare(util.chunkAfterPos(segls,[0,0]),'')
        compare(util.chunkAfterPos(segls,[1,0]),'')
        compare(util.chunkAfterPos(segls,[0,1]),'1.4')
        compare(util.chunkAfterPos(segls,[1,1]),'.4')
        compare(util.chunkAfterPos(segls,[3,1]),'')
        compare(util.chunkAfterPos(segls,[5,1]),'')
        compare(util.chunkAfterPos(segls,[6,1]),'x:z')
        compare(util.chunkAfterPos(segls,[7,1]),':z')
    })
