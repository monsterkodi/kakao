...
funcArgs = function ()
{
    ...
    if (_k_.in(turd[0],'=-') && turd[1] === '>')
    {
        ...
        if (line.chunks[0].clss === 'text' && _k_.in(line.chunks[1].match,':='))
        {
            var list1 = _k_.list(line.chunks.slice(2, typeof chunkIndex === 'number' ? chunkIndex : -1))
            for (var _248_19_ = 0; _248_19_ < list1.length; _248_19_++)
            {
                ch = list1[_248_19_]
                if (ch.clss === 'function call')
                {
...
dashArrow = function ()
{
    var markFunc, _282_77_, _305_77_

    if (notCode)
    {
        return
    }
    console.log('dashArrow',line.chunks)
    console.log('dashArrow chunk',chunkIndex,chunk)
    markFunc = function ()
    {
...
kodePunct = function ()
{
    var next, prev, prevEnd, _381_21_
    ...
    if (prev = getChunk(-1))
    {
        ...
        if (prev.match === '▸')
        {
            if (_k_.empty(getChunk(-2)))
            {
                ...
                for (var _420_22_ = 0; _420_22_ < list1.length; _420_22_++)
                {
                    c = list1[_420_22_]
                    c.clss = 'section'
                }
...
{
    var next, prev, prevEnd, _483_21_
...
urlPunct = function ()
{
    ...
    if (prev = getChunk(-1))
    {
        ...
        if (chunk.match === '/')
        {
            for (var _662_22_ = i = chunkIndex, _662_34_ = 0; (_662_22_ <= _662_34_ ? i <= 0 : i >= 0); (_662_22_ <= _662_34_ ? ++i : --i))
            {
...
jsonPunct = function ()
{
    ...
    if (chunk.match === ':')
    {
        if (prev = getChunk(-1))
        {
            if (prev.match === '"')
            {
                for (var _730_26_ = i = Math.max(0,chunkIndex - 2), _730_52_ = 0; (_730_26_ <= _730_52_ ? i <= 0 : i >= 0); (_730_26_ <= _730_52_ ? ++i : --i))
                {
...
escape = function ()
{
    var _763_46_, _764_26_, _768_61_, _771_61_
...
mdPunct = function ()
{
    var type, _1024_21_, _1049_21_, _999_65_
...
shPunct = function ()
{
    var _1175_42_, _1175_64_, _1178_102_, _1178_41_, _1178_82_, _1184_102_, _1184_41_, _1184_82_
...
getValue = function (d)
{
    var _1245_29_, _1245_36_

    return ((_1245_36_=(getChunk(d) != null ? getChunk(d).clss : undefined)) != null ? _1245_36_ : '')
}

getmatch = function (d)
{
    var _1246_29_, _1246_37_

    return ((_1246_37_=(getChunk(d) != null ? getChunk(d).match : undefined)) != null ? _1246_37_ : '')
}
...
addValues = function (n, value)
{
    ...
    for (var _1253_14_ = i = 0, _1253_18_ = n; (_1253_14_ <= _1253_18_ ? i < n : i > n); (_1253_14_ <= _1253_18_ ? ++i : --i))
    {
        addValue(i,value)
    }
    return n
...
for (var _1296_8_ = 0; _1296_8_ < list1.length; _1296_8_++)
{
    ext = list1[_1296_8_]
...
{
    var advance, beforeIndex, hnd, mightBeHeader, mtch, turdChunk, _1387_40_, _1402_61_
    ...
    for (var _1338_13_ = 0; _1338_13_ < list2.length; _1338_13_++)
    {
        line = list2[_1338_13_]
        if (stackTop)
        {
            if (stackTop.type === 'comment triple')
            {
                ...
                for (var _1345_26_ = 0; _1345_26_ < list3.length; _1345_26_++)
                {
                    chunk = list3[_1345_26_]
                    if (!HEADER.test(chunk.match))
                    {
                        mightBeHeader = false
                        break
                ...
                if (mightBeHeader)
                {
                    ...
                    for (var _1350_30_ = 0; _1350_30_ < list4.length; _1350_30_++)
                    {
                        chunk = list4[_1350_30_]
                        chunk.clss = 'comment triple header'
                    }
                    continue
                }
        ...
        while (chunkIndex < line.chunks.length)
        {
            ...
            if (chunk.clss.startsWith('punct'))
            {
                ...
                for (var _1391_24_ = 0; _1391_24_ < list5.length; _1391_24_++)
                {
                    hnd = list5[_1391_24_]
                    if (advance = hnd())
                    {
            ...
            else
            {
                if (!notCode)
                {
                    if (mtch = (swtch[line.ext] != null ? swtch[line.ext][chunk.match] : undefined))
                    {
                        if (mtch.turd)
                        {
                            ...
                            if (mtch.turd === (((_1402_61_=(turdChunk != null ? turdChunk.turd : undefined)) != null ? _1402_61_ : (turdChunk != null ? turdChunk.match : undefined))))
                            {
                                pushExt(mtch)
                            }
                        }
                ...
                for (var _1408_24_ = 0; _1408_24_ < list6.length; _1408_24_++)
                {
                    hnd = list6[_1408_24_]
                    if (advance = hnd())
                    {
...
{
    var index, _1442_25_, _1447_30_

    var list2 = _k_.list(lines)
    for (var _1436_13_ = 0; _1436_13_ < list2.length; _1436_13_++)
    {
        line = list2[_1436_13_]
...
kolorize = function (chunk)
{
    ...
    if (cn = kolor.map[chunk.clss])
    {
        if (cn instanceof Array)
        {
            ...
            for (var _1479_19_ = 0; _1479_19_ < list2.length; _1479_19_++)
            {
                cr = list2[_1479_19_]
                v = kolor[cr](v)
            }
...
kolorizeChunks = function (chunks = [], number)
{
    ...
    c = 0
    for (var _1508_14_ = i = 0, _1508_18_ = chunks.length; (_1508_14_ <= _1508_18_ ? i < chunks.length : i > chunks.length); (_1508_14_ <= _1508_18_ ? ++i : --i))
    {
...
syntax = function (arg)
{
    var clines, index, lines, numbers, rngs, text, _1526_19_, _1527_25_

    arg = (arg != null ? arg : {})
    text = arg.text
    ext = ((_1526_19_=arg.ext) != null ? _1526_19_ : 'coffee')
    numbers = ((_1527_25_=arg.numers) != null ? _1527_25_ : false)
    ...
    clines = []
    for (var _1532_18_ = index = 0, _1532_22_ = lines.length; (_1532_18_ <= _1532_22_ ? index < lines.length : index > lines.length); (_1532_18_ <= _1532_22_ ? ++index : --index))
    {
        line = lines[index]
