...
ked [file]
    ...
    {
        var _200_22_, _201_23_, _202_22_, _203_23_

        this.viewSizes[name] = [x,y]
        lfc(_k_.noon((this.viewSizes)))
        ;(this.editor.mapscr != null ? this.editor.mapscr.onPreResize() : undefined)
        ;(this.konsole.mapscr != null ? this.konsole.mapscr.onPreResize() : undefined)
