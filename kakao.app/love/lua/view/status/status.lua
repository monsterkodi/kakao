...
function status:init(screen, editor) 
        self.screen = screen
        self.editor = editor
        ...
        self.crumbs = crumbs(self.screen, 'status_crumbs')
        self.statusfile = statusfile(self.screen, 'status_file')
        self.filepos = bubble(self.screen, "status_filepos")
