...
test("kstr", function()
    ...
    test("split", function()
        test.cmp(kstr.split("/", "/"), {"", ""})
        test.cmp(kstr.split("a/b/c", "/"), {"a", "b", "c"})
        test.cmp(kstr.split("/b/c", "/"), {"", "b", "c"})
        test.cmp(kstr.split("/b/", "/"), {"", "b", ""})
        test.cmp(kstr.split("//", "/"), {"", "", ""})
        test.cmp(kstr.split("//", ""), {"/", "/"})
        test.cmp(kstr.split("a.b.c.d", ".", 0), {"a.b.c.d"})
        test.cmp(kstr.split("a.b.c.d", ".", 1), {"a", "b.c.d"})
        test.cmp(kstr.split("a.b.c.d", ".", 2), {"a", "b", "c.d"})
    end)
