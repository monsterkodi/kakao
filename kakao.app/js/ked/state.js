...
state = (function ()
{
    ...
    state.prototype["copy"] = function ()
    {
        ...
        switch (os.platform())
        {
            ...
            case 'linux':
            case 'win32':
                lf(_k_.noon((this.textForSelectionOrCursorLines())))
    ...
    state.prototype["paste"] = function ()
    {
        ...
        switch (os.platform())
        {
            ...
            case 'linux':
            case 'win32':
                text = child_process.execSync(`${_k_.dir()}/../../bin/utf8clip.exe`).toString("utf8")
                lf(_k_.noon((text)))
