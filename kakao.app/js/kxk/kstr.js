...
str.fillet = function (s, wordCharacterSet = '')
{
    ...
    for (var _51_14_ = ci = 0, _51_18_ = s.length; (_51_14_ <= _51_18_ ? ci < s.length : ci > s.length); (_51_14_ <= _51_18_ ? ++ci : --ci))
    {
        ch = s[ci]
        if (_k_.in(ch,' \t\n\r'))
        {
...
str.unfillet = function (fillets)
{
    ...
    for (var _81_15_ = 0; _81_15_ < list.length; _81_15_++)
    {
        fillet = list[_81_15_]
...
str.time = function (t)
{
    ...
    switch (typeof(t))
    {
        case 'number':
            ...
            for (var _267_18_ = 0; _267_18_ < list.length; _267_18_++)
            {
                k = list[_267_18_]
                num = parseInt(t / f)
                f *= o[k]
