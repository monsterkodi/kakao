...
var ext, extlang, extlangFile, exts, json, keywords, lang, langNoon, names, noonFile, value, word, words, _32_18_
...
for (names in langNoon)
{
    ...
    for (var _30_12_ = 0; _30_12_ < list.length; _30_12_++)
    {
        ext = list[_30_12_]
        if (!(_k_.in(ext,exts)))
        {
        ...
        lang[ext] = ((_32_18_=lang[ext]) != null ? _32_18_ : {})
        for (value in keywords)
        {
            words = keywords[value]
            var list1 = _k_.list(words)
            for (var _34_21_ = 0; _34_21_ < list1.length; _34_21_++)
            {
                word = list1[_34_21_]
                lang[ext][word] = value
            }
