...
{
    var compText, file, ignore, jsDir, kodeDir, list, pugDir, rule, rules, skip, srcFile, srcText, tgtFile, tgtText, transpiled, _20_23_, _21_16_
    ...
    opt.verbose = ((_21_16_=opt.verbose) != null ? _21_16_ : false)
    if (opt.verbose)
    {
        console.log('opt',opt)
    }
    ...
    for (var _68_13_ = 0; _68_13_ < list1.length; _68_13_++)
    {
        ...
        for (var _71_19_ = 0; _71_19_ < list2.length; _71_19_++)
        {
            ignore = list2[_71_19_]
