...
var ext, extlang, extlangFile, exts, json, jsonFile, keywords, lang, langNoon, names, noonFile, value, word, words, __dirname, _30_18_
...
noonFile = slash.path(__dirname,'..','..','kode','klor','lang.noon')
jsonFile = slash.path(__dirname,'lang.json')
extlangFile = slash.path(__dirname,'extlang.js')
...
for (names in langNoon)
{
    ...
    for (var _28_12_ = 0; _28_12_ < list.length; _28_12_++)
    {
        ext = list[_28_12_]
        if (!(_k_.in(ext,exts)))
        {
        ...
        lang[ext] = ((_30_18_=lang[ext]) != null ? _30_18_ : {})
        for (value in keywords)
        {
            words = keywords[value]
            var list1 = _k_.list(words)
            for (var _32_21_ = 0; _32_21_ < list1.length; _32_21_++)
            {
                word = list1[_32_21_]
                lang[ext][word] = value
            }
...
if (await fs.write(jsonFile,json))
{
